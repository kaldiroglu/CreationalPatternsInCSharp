    ...
    public class Account : ICloneable
    {
        ...
        public object Clone()
        {
            ...
            catch (Exception e)
            {
                ...
                Console.WriteLine(e.ToString()); // For stack trace
            }
            return cloneAccount;
        }
        ...
        {
            Account cloneAccount = (Account)normalPrototype.Clone();
           // Account cloneAccount = new Account("1", balance, 0, owner, true, false, false);
            cloneAccount.Owner = owner;
            cloneAccount.Balance = balance;
            cloneAccount.Iban = "-1";
            //cloneAccount.owner = null;
            return cloneAccount;
        }
        ...
        {
            Account cloneAccount = (Account)negativePrototype.Clone();
            cloneAccount.Owner = owner;
            cloneAccount.Balance = balance;
            return cloneAccount;
        }
        ...
        {
            Account cloneAccount = (Account)frozenPrototype.Clone();
            cloneAccount.Owner = owner;
            cloneAccount.Balance = balance;
            return cloneAccount;
        }
